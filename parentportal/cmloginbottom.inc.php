...
<? if (isset($_SERVER["HTTPS"])) { ?>
			<div style="float:right">
				<table width="135" border="0" cellpadding="2" cellspacing="0" title="<?=_L("Click to Verify - This site chose VeriSign SSL for secure e-commerce and confidential communications.")?>">
					<tr>
					<td width="135" align="center" valign="top"><script src=https://seal.verisign.com/getseal?host_name=contactme.schoolmessenger.com&size=M&use_flash=YES&use_transparent=YES&lang=<?=substr($LOCALE, 0, 2)?>></script><br />
