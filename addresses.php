...
function fmt_actions($row, $name) {
	return "<a href=\"address.php?id=$row[0]\">Edit</a>&nbsp;|&nbsp;<a href=\"?delete=$row[0]\" onclick=\"return confirmDelete();\">Delete</a>";
}
...
if ($_SESSION['addressOrigin'] == 'list' && $_SESSION['listid'] == null) {
