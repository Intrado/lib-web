...
<? } ?>
			<li><a href="#" onclick="window.open('help/index.php', '_blank', 'width=960,height=500,location=no,menubar=yes,resizable=yes,scrollbars=yes,status=no,titlebar=no,toolbar=yes');">Help</a></li>
