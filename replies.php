...
$detailedquery = "select SQL_CALC_FOUND_ROWS
			...
			left join reportcontact rc on (rp.personid = rc.personid and rp.jobid = rc.jobid and rp.type = rc.type and rc.sequence = vr.sequence AND rc.result NOT IN('declined'))
