...
require_once("obj/UndeliveredReport.obj.php");
////////////////////////////////////////////////////////////////////////////////
// Authorization
////////////////////////////////////////////////////////////////////////////////
...
$ordering = UndeliveredReport::getOrdering();
...
if(isset($_SESSION['reportid'])){
	...
	$options['reporttype'] = "undelivered";
	...
	else
	{
		...
		if( CheckFormSection($f, $s) ) {
			...
			if(!$error && (CheckFormSubmit($f, "run") || CheckFormSubmit($f, "saveview") ))
				redirect("reportundeliveredresult.php");
		}
	}
} else {
	$reload=1;
