...
if (isset($_GET['download'])) {
	$userdetails = Query("
		select u.login, u.accesscode, u.firstname, u.lastname, u.description, u.phone, us.value callerid, u.email, u.aremail, u.enabled, u.lastlogin, u.ldap, u.samlEnabled, u.staffpkey, a.name, a.description profiledescription,
	...
	// echo out the data
	echo '"login","accesscode","firstname","lastname","description","phone","callerid","email","aremail","enabled","lastlogin","ldap","saml","staffpkey","profile name","profile description","jobtypes","sections","organizations","fieldnum","op","val"' . "\n";
