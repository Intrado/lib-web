...
/**
 * @todo - move as many of rht JS functions (such as doValidate) to the
 *         RCIEditor class to keep as much of the JS code as possible
 *         centralized there.
 * @todo - change any JS code that remains to OOP model to guarantee no
	...
	<head>
		...
		<script language="JavaScript">
			...
			function wysiwygInit() {
				...
				window.frames.top.wysiwygEditorLoad('wysiwygpage');
			}
				...
				*/
				...
				for (var i = 0; i < editableBlocks.length; i++) {
					makeNonEditable(editableBlocks[i]);
                                ...
                                //content = window.top.cleanContent(wysiwygpresave.html()); // jquery.js
				var content = window.top.cleanContent(wysiwygpresave.innerHTML); // prototype.js
