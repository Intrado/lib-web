...
//    $('.attachmentPreloader').hide();
    ...
    if (Object.keys(values).length > 0)
    {
        ...
        for(var contentid in values) {
            ...
            var attachment = $('<a data-attachment-id="' + contentid + '" class="emailAttachment" href="../emailattachment.php?id='  + contentid +  '&name=' + encodeURIComponent(encodeURIComponent(content.name)) + '" >' + content.name + '</a>');
