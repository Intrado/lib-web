...
if (isset($_GET['oauth_token']) && isset($_GET['oauth_verifier']) && isset($_SESSION['twitterRequestToken'])) {
	...
	// HACK; initially user_id we can get from the first part of oauth_token before the "-"
	$tokenParts = explode('-', $_GET['oauth_token']);
	...
	$twitterTokens->addAccessToken((object) $token);
