...
INSERT INTO `jobtype` VALUES (1,'Emergency',10000,1,225,0),(2,'Attendance',20000,2,0,0),(3,'General',30000,3,450,0)
$$$
...
INSERT INTO `setting` VALUES (1,'maxphones','3'),(2,'maxemails','2'),(3,'retry','15'),(4,'disablerepeat','0'),(5,'surveyurl','http://myschool.com/survey/'),(6,'displayname','CommSuite Customer'),(7,'timezone','US/Pacific'),(8,'inboundnumber',''),(9,'_maxusers','5'),(10,'_renewaldate',''),(12,'_callspurchased',''),(13,'checkpassword','0'),(14,'_hassms','0')
$$$
