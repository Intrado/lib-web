...
?>
	<table  border="0" cellpadding="3" cellspacing="0" id="<?=$tablename?>">
		<tr>
			...
			<td><div id="date">From: <? NewFormItem($f, $s, "startdate", "text", "20",NULL,"onfocus=\"this.select();lcs(this,true)\" onclick=\"event.cancelBubble=true;this.select();lcs(this,true)\"") ?> To: <? NewFormItem($f, $s, "enddate", "text", "20",NULL,"onfocus=\"this.select();lcs(this,true)\" onclick=\"event.cancelBubble=true;this.select();lcs(this,true)\"")?></div></td>
		</tr>
		<script>
