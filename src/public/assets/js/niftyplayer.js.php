...
function embedPlayer(url,target,parts) {
	...
	if(hasflash) {
		...
		preview_obj = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="//download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="165" height="38" id="niftyPlayer1" align="">' +
			'<param name=movie value="assets/media/niftyplayer.swf?file=' + encodeURIComponent(requestfiles)  + '&as=1">' + 
			'<param name=quality value=high>' + 
			'<param name=bgcolor value=#FFFFFF>' + 
			'<embed src="assets/media/niftyplayer.swf?file=' + encodeURIComponent(requestfiles) + '&as=1" quality=high bgcolor=#FFFFFF width="165" height="38" name="niftyPlayer1" align="" type="application/x-shockwave-flash" pluginspage="//get.adobe.com/flashplayer">' +
			'</embed>' + 
			'</object>';
	} else {
<?
