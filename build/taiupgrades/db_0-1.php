...
function tai_upgrade_0_1 ($rev, $shardid, $customerid, $db) {
	...
	switch($rev) {
		...
		case 8:
			echo "|";
			apply_sql("taiupgrades/db_0-1_pre.sql", $customerid, $db, 9);
		case 9:
			echo "|";
			apply_sql("taiupgrades/db_0-1_pre.sql", $customerid, $db, 10);
		case 10:
			echo "|";
			apply_sql("taiupgrades/db_0-1_pre.sql", $customerid, $db, 11);
	}
