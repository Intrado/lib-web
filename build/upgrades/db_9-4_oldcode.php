...
class Message_9_4 extends DBMappedObject {
	var $userid;
	var $messagegroupid;
	var $name;
	var $description;
...
class MessagePart_9_4 extends DBMappedObject {
	...
	function MessagePart_9_4 ($id = NULL) {
		$this->_allownulls = true;
...
class MessageGroup_9_4 extends DBMappedObject {
	var $userid;
	...
	function MessageGroup_9_4 ($id = NULL) {
		$this->_allownulls = true;
