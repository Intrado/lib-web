...
function upgrade_11_2($rev, $shardid, $customerid, $db) {
	...
	case 5:
		echo "|";
		apply_sql("upgrades/db_11-2_pre.sql", $customerid, $db, 6);
	case 6:
		echo "|";
		apply_sql("upgrades/db_11-2_pre.sql", $customerid, $db, 7);
	case 7:
		echo "|";
		apply_sql("upgrades/db_11-2_pre.sql", $customerid, $db, 8);
	}
