					...
					<form class="form-horizontal" role="form">
						...
						<div id="email-details">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<p class="form-control-static"><a href="mailto:<?= escapeHtml($this->emailMessage->fromEmail) ?>" ><?= escapeHtml($this->emailMessage->fromName) ?> <span class="normal">&lt;<?= escapeHtml($this->emailMessage->fromEmail) ?>&gt;</span></a></p>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<p class="form-control-static"><a href="">view message</a></p>
								</div>
							</div>
						</div>
