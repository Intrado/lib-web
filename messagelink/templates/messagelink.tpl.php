			...
			<div class="col-sm-10 col-md-offset-1">
				<div class="well well-lg">
					<form class="form-horizontal" role="form">
						...
						<div id="secure-document-wrapper" class="form-group">
							<div class="instruction">
								<span class="glyphicon glyphicon-info-sign"></span> &nbsp;Listen to your voice message below.
							</div>
							<div class="form-group">
						...
						<div class="instruction">
							Save the voice message to your computer.
						</div>
						<div class="form-group">
