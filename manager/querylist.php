...
?>
			...
			<td><a href="queryrun.php?id=<?="$id"?>&cid=<?="$cid"?>" title="Run"><img src="mimg/application_go.png" border=0></a></td>
			</tr>
<?				
		}
	}
...
?>
			...
			<td><?=escapehtml($managerquery->name)?></td>
			<td><div style="overflow: hidden; white-space:nowrap;"><?=escapehtml($managerquery->notes)?></div></td>
			<td><a href="queryrun.php?id=<?="$id".($cid?"&cid=$cid":"")?>" title="Run"><img src="mimg/application_go.png" border=0></a></td>
			</tr>
<?
		}
	}
