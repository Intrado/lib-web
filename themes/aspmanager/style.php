...
.banner_links li a:hover { color: #6699CC; text-decoration: none; }
...
.pagetitle { font-family: Verdana, Arial, sans-serif; margin: 0.5em 0; color: #CCCCCC; }
...
-moz-background-clip: padding; -webkit-background-clip: padding-box; background-clip: padding-box; 
-webkit-box-shadow: inset 0px 0px 2px #fff; -moz-box-shadow: inset 0px 0px 2px #fff; box-shadow: inset 0px 0px 2px #fff; }
.btn:hover { background: #CCCCCC; color: #fff; border: 1px solid #053315; 
