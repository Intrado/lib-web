...
background-image: -webkit-gradient(linear, left top, left bottom, from(#0d8336), to(#da6c17)); 
  background-image: -webkit-linear-gradient(top, #0d8336, #065d24); 
  background-image:    -moz-linear-gradient(top, #0d8336, #065d24); 
  background-image:     -ms-linear-gradient(top, #0d8336, #065d24); 
  background-image:      -o-linear-gradient(top, #0d8336, #065d24); 
  background-image:         linear-gradient(top, #0d8336, #065d24); }
...
.feedtitle a:hover, .actionlink:hover, .feed_title:hover { color: #3E693F; }
