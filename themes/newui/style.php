...
.templates { padding: 11px 15px; background-color: #EBE7E1;
...
.help { background-color: #F5F3F0; margin: 25px 0 0; padding: 11px 15px; border: 1px solid #D6CEC2; -webkit-border-radius: 5px; border-radius: 5px; }
