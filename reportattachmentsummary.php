...
require_once("obj/AttachmentSummaryReport.obj.php");
...
$generator = new AttachmentSummaryReport();
...
if ($generator->format != "html") {
	...
	buttons($back, icon_button(_L('Refresh'),"arrow_refresh","window.location.reload()"));
