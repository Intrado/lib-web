...
button_bar(button('createjob', NULL,"survey.php?id=new"));
...
showObjects($data, $titles, array('Status' => 'fmt_status', "startdate" => "fmt_job_startdate", "finishdate" => "fmt_obj_date", "Actions" => "fmt_jobs_actions"), count($data) > 8, true);
